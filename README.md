...
Команда склонирует репозиторий, поставит все зависимости, соберёт расширение, упакует VSIX и установит его в VS Code. После завершения перезагрузите окно (**Ctrl+Shift+P → Developer: Reload Window**), и в боковой панели появится иконка WPDock.
