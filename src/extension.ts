...
export async function activate(context: vscode.ExtensionContext) {
  ...
  // A VS Code reload stops child processes in deactivate(), but the persisted
  // running status represents user intent. Restore those sites immediately so
  // their *.local URLs remain available without another manual click.
  void siteManager.resumePreviouslyRunningSites();
