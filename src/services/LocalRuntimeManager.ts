...
// windows.php.net keeps only the current-latest patch build under `releases/`;
// anything superseded by a newer point release 404s there and only exists
// under `releases/archives/`, pin to archives so a hardcoded version here
// doesn't break the moment PHP ships the next patch.
const PHP_WIN_URLS: Record<string, string> = {
  '8.3': 'https://downloads.php.net/~windows/releases/archives/php-8.3.31-nts-Win32-vs16-x64.zip',
  '8.2': 'https://downloads.php.net/~windows/releases/archives/php-8.2.31-nts-Win32-vs16-x64.zip',
  '8.1': 'https://downloads.php.net/~windows/releases/archives/php-8.1.34-nts-Win32-vs16-x64.zip',
  '8.0': 'https://downloads.php.net/~windows/releases/archives/php-8.0.30-nts-Win32-vs16-x64.zip',
};
