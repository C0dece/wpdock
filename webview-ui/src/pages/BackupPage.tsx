    ...
    <div className="page sidebar-detail-page">
      ...
      <div className="detail-hero card">
        <div className="site-card-meta-row">
          ...
          <span className="site-card-chip">{configuredProviders.length > 0 ? configuredProviders.join(', ') : 'облако не подключено'}</span>
        </div>
        <div className="detail-summary-grid">
          ...
          <div className="overview-stat"><span className="overview-stat-value">{configuredProviders.length}</span><span className="overview-stat-label">облаков</span></div>
          <div className="overview-stat"><span className="overview-stat-value">{config?.autoBackup ? 'Включён' : 'Выключен'}</span><span className="overview-stat-label">автобэкап</span></div>
          <div className="overview-stat"><span className="overview-stat-value">{config?.includeDb ? 'С БД' : 'Файлы'}</span><span className="overview-stat-label">содержимое</span></div>
        </div>
