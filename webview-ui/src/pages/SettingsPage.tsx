    ...
    <div className="page sidebar-detail-page">
      <div className="page-header">
        ...
        <div className="page-title-wrap">
          ...
          <div className="page-subtitle">сайты · загрузка · резервные копии</div>
        </div>
      </div>
        ...
        <>
          <div className="detail-hero card">
            <div className="site-card-meta-row">
              <span className="badge badge-green">Глобальные</span>
            ...
            <div className="detail-summary-grid">
              ...
              <div className="overview-stat"><span className="overview-stat-value">{settings.autoBackup ? 'Включены' : 'Выключены'}</span><span className="overview-stat-label">автобэкапы</span></div>
              <div className="overview-stat"><span className="overview-stat-value">{settings.directUploadLimitMb} МБ</span><span className="overview-stat-label">прямая загрузка</span></div>
            </div>
            <div className="section-copy">
              Значения по умолчанию для новых сайтов, передачи файлов и резервного копирования.
            </div>
          </div>
          ...
          <div className="stack-sm">
            ...
            <section className="card">
              ...
              <div className="section-copy">
                Если архив меньше лимита, он идёт одним запросом. Если больше, включается батчинг по чанкам.
              </div>
              <div className="form-row">
                <div className="form-group">
